...
IUSE="X +encode gsm jpeg2k libav mp3 opus sdl theora threads truetype vaapi vdpau x264"

RDEPEND="
	libav? ( >=media-video/libav-9.12[X?,encode?,gsm?,jpeg2k?,mp3?,opus?,sdl?,theora?,threads?,truetype?,vaapi?,vdpau?,x264?] )
	!libav? ( >=media-video/ffmpeg-1.2.6-r1:0[X?,encode?,gsm?,jpeg2k?,mp3?,opus?,sdl?,theora?,threads?,truetype?,vaapi?,vdpau?,x264?] )
"
